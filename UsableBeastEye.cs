...
[assembly: MelonInfo(typeof(UsableBeastEye), "Usable Beast Eye (cheaper variant)", "1.1.0", "Matthiew Purple")]
...
public class UsableBeastEye : MelonMod
{
    ...
    public override void OnInitializeMelon()
    {
        ...
        // Raises Dragon Eye's cost to 75 MP
        datNormalSkill.tbl[220].cost = 75;
    }
}
